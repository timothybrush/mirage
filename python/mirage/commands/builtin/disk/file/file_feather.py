...
@command("file", resource="disk", spec=SPECS["file"], filetype=".arrow")
@command("file", resource="disk", spec=SPECS["file"], filetype=".ipc")
@command("file", resource="disk", spec=SPECS["file"], filetype=".feather")
