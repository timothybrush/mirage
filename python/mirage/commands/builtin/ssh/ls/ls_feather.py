...
@command("ls", resource="ssh", spec=SPECS["ls"], filetype=".arrow")
@command("ls", resource="ssh", spec=SPECS["ls"], filetype=".ipc")
@command("ls", resource="ssh", spec=SPECS["ls"], filetype=".feather")
