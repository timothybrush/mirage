...
from mirage.core.filetype.orc import stat as orc_stat
    ...
    **_extra: object,
    ...
    try:
        ...
        return None, IOResult(
            exit_code=1,
            stderr=f"stat: {p.original}: failed to read as orc: {e}".encode(),
        )
