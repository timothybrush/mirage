...
@command("file", resource="s3", spec=SPECS["file"], filetype=".arrow")
@command("file", resource="s3", spec=SPECS["file"], filetype=".ipc")
@command("file", resource="s3", spec=SPECS["file"], filetype=".feather")
